...
class TestGetSicCodes:
    @patch("bestee_compute.stocks.sic.httpx.get")
    ...
    @patch("bestee_compute.stocks.sic._load_cache", return_value=_CACHED_ROWS)
    @patch(
        "bestee_compute.stocks.sic._scrape_sic_codes",
    ...
    @patch("bestee_compute.stocks.sic._load_cache", return_value=None)
    @patch(
        "bestee_compute.stocks.sic._scrape_sic_codes",
        side_effect=Exception("network down"),
    )
    ...
    @patch("bestee_compute.stocks.sic._save_cache")
    @patch("bestee_compute.stocks.sic.httpx.get")
