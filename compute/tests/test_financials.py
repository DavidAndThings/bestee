"""Tests for bestee_compute.stocks.financials."""

from unittest.mock import MagicMock, patch

from great_tables import GT

from bestee_compute.stocks.financials import (
    _group_metrics,
    _period_sort_key,
    _resolve_ticker,
    build_financials_table,
)
from bestee_compute.stocks.models import FinancialMetric, Metric, StatementType

_CLIENT_PATCH = "bestee_compute.stocks.financials.get_client"
