"""Tests for bestee_compute.etf.vaneck — VanEck ETF holdings scraper."""
...
from bestee_compute.etf._xlsx import col_letter_to_index
from bestee_compute.etf.vaneck import (
...
_HTTPX_PATCH = "bestee_compute.etf.vaneck.httpx.Client"
