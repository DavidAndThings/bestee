"""Tests for bestee.etf.issuer — ETF-issuer guessing from ticker name."""
...
from bestee.etf.issuer import _match_issuer, guess_etf_issuer

# Patch the cross-module helper that issuer.py pulls in from stocks/.
_LOOKUP_PATCH = "bestee.etf.issuer.get_ticker_detail"
