"""Tests for bestee.etf.pca — cross-ETF PCA on weighted holdings."""
...
from bestee.etf.pca import ETFPCAResult, _join_key, etf_pca

_NORMALIZE_PATCH = "bestee.etf.pca.get_holdings_normalized"
