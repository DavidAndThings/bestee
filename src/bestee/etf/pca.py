...
from bestee.etf.normalize import get_holdings_normalized
...
def etf_pca(
    ...
    *,
    ...
    1. Fetch each ETF's holdings in canonical schema via
       :func:`bestee.etf.normalize.get_holdings_normalized` (dispatches
    ...
    Args:
        tickers: At least two ETF tickers.  Each is dispatched via the
            issuer-aware :mod:`bestee.etf.holdings` registry, so any
