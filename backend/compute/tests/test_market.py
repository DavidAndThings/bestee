"""Tests for bestee_compute.stocks.market."""
...
from bestee_compute.stocks.models import TimeSeriesDef, TimeSeriesName, TimeSeriesSpan

_CLIENT_PATCH = "bestee_compute.stocks.market.get_client"
