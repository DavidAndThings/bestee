"""Tests for bestee_compute.etf.invesco — Invesco QQQ holdings scraper."""
...
from bestee_compute.etf.invesco import (
...
_HTTPX_PATCH = "bestee_compute.etf.invesco.httpx.Client"
