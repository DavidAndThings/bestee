"""Tests for bestee_compute.etf.normalize — canonical-schema projection."""
...
from bestee_compute.etf.ishares import _parse_holdings_csv as _parse_ishares_csv
from bestee_compute.etf.normalize import (
    _CANONICAL_COLS,
    _COLUMN_MAP,
...
from bestee_compute.etf.spdr import _parse_holdings_xlsx as _parse_spdr_xlsx
from bestee_compute.etf.vaneck import _parse_holdings_xlsx as _parse_vaneck_xlsx
...
@patch("bestee_compute.etf.normalize._resolve_provider")
