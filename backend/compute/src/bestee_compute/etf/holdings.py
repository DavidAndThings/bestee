...
publishes it.  The dispatcher calls :func:`bestee_compute.etf.issuer.guess_etf_issuer`
...
3. Make sure :data:`bestee_compute.etf.issuer._ISSUER_PATTERNS` returns the
...
# ``bestee_compute.etf.holdings.<provider>`` and have the dispatch honour it.
